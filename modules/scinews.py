...
_FEEDS: dict[str, tuple[str, set[str]]] = {
    ...
    "Symmetry Mag":    ("https://www.symmetrymagazine.org/feed",               {"physics"}),
    "MIT News Phys":   ("https://news.mit.edu/rss/topic/physics",              {"physics"}),
    "Backreaction":    ("https://feeds.feedburner.com/Backreaction",            {"physics"}),
    "Not Even Wrong":  ("https://www.math.columbia.edu/~woit/wordpress/?feed=rss2", {"physics", "math"}),
    "Nature Physics":  ("https://www.nature.com/nphys.rss",                    {"physics"}),
    "PRL":             ("https://feeds.aps.org/rss/recent/prl.xml",            {"physics"}),
    "SciDaily Phys":   ("https://www.sciencedaily.com/rss/matter_energy/physics.xml", {"physics"}),
    "CERN Courier":    ("https://cerncourier.com/feed/",                       {"physics"}),
    "Quantum Front.":  ("https://quantumfrontiers.com/feed/",                  {"physics"}),
    "Fermilab":        ("https://news.fnal.gov/feed/",                         {"physics"}),
    "MIT Physics":     ("https://physics.mit.edu/feed",                        {"physics"}),
    ...
    "Cell":            ("https://www.cell.com/cell/current.rss",                {"bio"}),
    "Current Biology": ("https://www.cell.com/current-biology/current.rss",     {"bio"}),
    "Neuron":          ("https://www.cell.com/neuron/current.rss",              {"bio"}),
    "PLOS Biology":    ("https://journals.plos.org/plosbiology/feed/atom",      {"bio"}),
    "PLOS Genetics":   ("https://journals.plos.org/plosgenetics/feed/atom",     {"bio"}),
    "Nature Genetics": ("https://www.nature.com/ng.rss",                        {"bio"}),
    "Nature Eco Evo":  ("https://www.nature.com/natecolevol.rss",               {"bio"}),
    "Nature Neuro":    ("https://www.nature.com/neuro.rss",                     {"bio"}),
    "Mongabay":        ("https://news.mongabay.com/feed/",                      {"bio", "earth"}),
    "J Ecology Blog":  ("https://jecologyblog.com/feed/",                       {"bio"}),
    # ── math ────────────────────────────────────────────────────────────
    ...
    "Terence Tao":     ("https://terrytao.wordpress.com/feed/",                 {"math"}),
    "Gowers":          ("https://gowers.wordpress.com/feed/",                   {"math"}),
    "Quanta Math":     ("https://www.quantamagazine.org/mathematics/feed/",     {"math"}),
    "The Aperiodical": ("https://aperiodical.com/feed/",                        {"math"}),
    "n-Category Cafe": ("https://golem.ph.utexas.edu/category/atom10.xml",      {"math"}),
    "Azimuth":         ("https://johncarlosbaez.wordpress.com/feed/",           {"math"}),
    "phys.org Math":   ("https://phys.org/rss-feed/science-news/mathematics/",  {"math"}),
    "SciNews Math":    ("https://www.sciencenews.org/topic/math/feed",          {"math"}),
    "Plus Magazine":   ("https://plus.maths.org/rss.xml",                       {"math"}),
    "AMS Bulletin":    ("https://www.ams.org/rss/bull.rss",                     {"math"}),
    "Lipton P=NP":     ("https://rjlipton.com/feed/",                           {"math"}),
    # ── space / astronomy ───────────────────────────────────────────────
    ...
    "Sky & Telescope": ("https://skyandtelescope.org/feed/",                    {"space"}),
    "SpaceNews":       ("https://spacenews.com/feed/",                          {"space"}),
    "NASASpaceflight": ("https://www.nasaspaceflight.com/feed/",                {"space"}),
    "Ars Space":       ("https://arstechnica.com/space/feed/",                  {"space"}),
    "Universe Today":  ("https://www.universetoday.com/feed/",                  {"space"}),
    "ESA":             ("https://www.esa.int/rssfeed/TopNews",                  {"space"}),
    "Spaceflight Now": ("https://spaceflightnow.com/feed/",                     {"space"}),
    "Planetary Soc":   ("https://www.planetary.org/rss/articles",               {"space"}),
    "EarthSky":        ("https://earthsky.org/feed/",                           {"space"}),
    "phys.org Space":  ("https://phys.org/rss-feed/space-news/",               {"space"}),
    "SciDaily Space":  ("https://www.sciencedaily.com/rss/space_time.xml",      {"space"}),
    # ── chemistry ───────────────────────────────────────────────────────
    ...
    "Angew. Chemie":   ("https://onlinelibrary.wiley.com/feed/15213773/most-recent", {"chem"}),
    "Chem World Res":  ("https://www.chemistryworld.com/410.rss",              {"chem"}),
    "Chem World News": ("https://www.chemistryworld.com/411.rss",              {"chem"}),
    "C&EN Latest":     ("https://feeds.feedburner.com/cen_latestnews",         {"chem"}),
    "In the Pipeline": ("https://www.science.org/blogs/pipeline/feed",         {"chem"}),
    "Nature Comms":    ("https://feeds.nature.com/ncomms/rss/current",         {"chem"}),
    "Nature Chem Bio": ("https://feeds.nature.com/nchembio/rss/current",       {"chem"}),
    "Nature Materials":("https://www.nature.com/nmat.rss",                     {"chem"}),
    "SciNews Chem":    ("https://www.sciencenews.org/topic/chemistry/feed",    {"chem"}),
    "Compound Chem":   ("https://www.compoundchem.com/feed/",                  {"chem"}),
    # ── earth / environmental ───────────────────────────────────────────
    ...
    "Yale Climate":    ("https://yaleclimateconnections.org/feed/",            {"earth"}),
    "WHOI":            ("https://www.whoi.edu/feed/",                          {"earth"}),
    "Scripps":         ("https://scripps.ucsd.edu/news/feed",                  {"earth"}),
    "NOAA NOS":        ("https://oceanservice.noaa.gov/rss/nosnews.xml",       {"earth"}),
    "VolcanoDiscovery":("https://www.volcanodiscovery.com/volcanonews.rss",    {"earth"}),
    "Skeptical Sci":   ("https://skepticalscience.com/feed.xml",               {"earth"}),
    "NOAA ENSO":       ("https://www.climate.gov/feeds/news-features/enso.rss",{"earth"}),
    "BGS Seismology":  ("https://earthquakes.bgs.ac.uk/feeds/WorldSeismology.xml", {"earth"}),
    # ── engineering ─────────────────────────────────────────────────────
    ...
    "EE Times":        ("https://www.eetimes.com/feed/",                       {"eng"}),
    "All About Circ":  ("https://www.allaboutcircuits.com/rss/news/",          {"eng"}),
    "Robot Report":    ("https://www.therobotreport.com/feed/",                {"eng", "tech"}),
    "PopSci":          ("https://www.popsci.com/feed/",                        {"eng"}),
    "PopMech":         ("https://www.popularmechanics.com/rss/all.xml/",       {"eng"}),
    "EE Portal":       ("https://electrical-engineering-portal.com/feed",      {"eng"}),
    # ── tech (CS, AI, general) ──────────────────────────────────────────
    ...
    "Arch Linux":      ("https://archlinux.org/feeds/news/",                   {"linux"}),
    "Bits from Debian":("https://bits.debian.org/feeds/feed.rss",              {"linux"}),
    "openSUSE":        ("https://news.opensuse.org/feed/",                     {"linux"}),
    "NixOS":           ("https://nixos.org/blog/feed.xml",                     {"linux"}),
    "Linux Mint":      ("https://blog.linuxmint.com/?feed=rss2",              {"linux"}),
    "Ubuntu Blog":     ("https://ubuntu.com/blog/feed",                        {"linux"}),
    "GamingOnLinux":   ("https://www.gamingonlinux.com/article_rss.php",       {"linux"}),
    "9to5Linux":       ("https://9to5linux.com/feed",                          {"linux"}),
    "DistroWatch":     ("https://distrowatch.com/news/dw.xml",                {"linux"}),
    "Red Hat":         ("https://www.redhat.com/en/rss/blog",                  {"linux"}),
    "Planet KDE":      ("https://planetkde.org/rss20.xml",                     {"linux"}),
    "Planet GNOME":    ("https://planet.gnome.org/rss20.xml",                  {"linux"}),
    "This Week GNOME": ("https://thisweek.gnome.org/index.xml",                {"linux"}),
    "Linux Foundation":("https://www.linuxfoundation.org/blog/rss.xml",        {"linux"}),
    # ── bsd ─────────────────────────────────────────────────────────────
    ...
    "FreeBSD Journal": ("https://freebsdfoundation.org/past-issues/feed/",     {"bsd"}),
    "DragonFly Digest":("https://www.dragonflydigest.com/feed",                {"bsd"}),
    "Netgate":         ("https://www.netgate.com/blog/rss.xml",                {"bsd"}),
    "TrueNAS":         ("https://www.truenas.com/feed/",                       {"bsd"}),
    "mwl.io":          ("https://mwl.io/feed",                                 {"bsd"}),
    "BSDSec":          ("https://bsdsec.net/articles.atom",                    {"bsd"}),
    "vermaden":        ("https://vermaden.wordpress.com/feed/",                {"bsd"}),
    "OPNsense":        ("https://opnsense.org/feed/",                          {"bsd"}),
    "Colin Percival":  ("https://www.daemonology.net/blog/index.rss",          {"bsd"}),
    "Julio Merino":    ("https://jmmv.dev/feed.xml",                           {"bsd"}),
    "Solene":          ("https://dataswamp.org/~solene/rss.xml",               {"bsd"}),
    # ── security ────────────────────────────────────────────────────────
    ...
    "Krebs":           ("https://krebsonsecurity.com/feed/",                   {"security"}),
    ...
    "PortSwigger":     ("https://portswigger.net/research/rss",                {"security"}),
    "The Record":      ("https://therecord.media/feed/",                       {"security"}),
    "Help Net Sec":    ("https://www.helpnetsecurity.com/feed/",               {"security"}),
    "DFIR Report":     ("https://thedfirreport.com/feed/",                     {"security"}),
    "Unit 42":         ("https://unit42.paloaltonetworks.com/feed/",           {"security"}),
    "Cisco Talos":     ("https://blog.talosintelligence.com/rss/",             {"security"}),
    "abuse.ch":        ("https://abuse.ch/rss/",                               {"security"}),
}
