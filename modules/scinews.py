...
_FEEDS: dict[str, tuple[str, set[str]]] = {
    ...
    "C&EN Latest":     ("http://feeds.feedburner.com/cen_latestnews",          {"chem"}),
    "In the Pipeline": ("https://www.science.org/blogs/pipeline/feed",         {"chem"}),
    "Nature Comms":    ("http://feeds.nature.com/ncomms/rss/current",          {"chem"}),
    "Nature Chem Bio": ("http://feeds.nature.com/nchembio/rss/current",        {"chem"}),
    ...
    "BGS Seismology":  ("http://earthquakes.bgs.ac.uk/feeds/WorldSeismology.xml", {"earth"}),
    # ── engineering ─────────────────────────────────────────────────────
